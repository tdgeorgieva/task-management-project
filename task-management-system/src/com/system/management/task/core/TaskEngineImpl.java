...
import com.system.management.task.core.contracts.TaskEngine;
...
public class TaskEngineImpl implements TaskEngine {
    ...
    public TaskEngineImpl() {
        ...
        TaskManagementRepository repo = new TaskManagementRepositoryImpl();
        this.repoHelper = new RepositoryHelper(repo);
    }
    ...
    private void processCommand(String inputLine) {
        ...
        Command command = commandFactory.createCommandFromCommandName(commandName, repoHelper);
